...
/*
extern int vm_mutex_init(korp_mutex *mutex);
extern int vm_mutex_destroy(korp_mutex *mutex);
extern void vm_mutex_lock(korp_mutex *mutex);
extern void vm_mutex_unlock(korp_mutex *mutex);
*/
